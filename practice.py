...
def graph():
    ...
    col = df.columns('Log Clean and Press', 'Farmers Carry w/ Keg Carry', 'Deadlift', 'Yolk & Tire Flip',
                        'Stones of Steel over a Bar')[subjects].mean()
    ...
    plt.bar(r4, Gordon_means, color='#800080', width=barWidth, edgecolor='white', label='Gordon Sam')
    plt.bar(r5, Richard_means, color='#ffa500', width=barWidth, edgecolor='white', label='Richard Castillo')
    plt.bar(r6, Zack_means, color='#00fff9', width=barWidth, edgecolor='white', label='Zack Bunke')
